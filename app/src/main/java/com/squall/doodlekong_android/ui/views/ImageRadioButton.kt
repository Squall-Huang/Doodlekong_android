package com.squall.doodlekong_android.ui.views
...
class ImageRadioButton @JvmOverloads constructor(
    ...
    init {
        context.theme.obtainStyledAttributes(
            ...
            try {
                val uncheckedId = getResourceId(
                    R.styleable.ImageRadioButton_uncheckedDrawable,
                    0
                )
                val checkedId = getResourceId(
                    R.styleable.ImageRadioButton_checkedDrawable,
                    0
                )
                if (uncheckedId != 0) {
